...
import com.acts.library.Formate;
...
public class Student implements Comparable<Student> {
	...
	public Student(int rollNo, String name, LocalDate dob, Course course,Set<Address> addressList) {
		this.rollNo = rollNo;
		this.name = name;
		this.dob = dob;
		this.course = course;
	...
	public String toString() {
		 return Formate.formate(rollNo+"", 10) + Formate.formate(name, 15) +
				Formate.formate(dob.toString(), 20) +Formate.formate(course+"", 15)+ addressList.toString();
	}
